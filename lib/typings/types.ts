...
export enum XrayIssueSeverity {
  Major = "Major",
  Minor = "Minor",
  Unknown = "Unknown"
}

export enum XrayIssueType {
  Security = "Security"
}

export enum XrayIssueProvider {
  Snyk = "Snyk",
  JFrog = "JFrog",
  Atomist = "Atomist"
}

export enum XrayPackageType {
  Maven = "Maven",
  Build = "Build"
}
...
export namespace XrayViolations {
  export type Variables = {};

  export type Subscription = {
    __typename?: "Subscription";
    XrayViolation?: XrayViolation[] | null;
  };

  export type XrayViolation = {
    __typename?: "XrayViolation";
    watch_name?: string | null;
    top_severity?: XrayIssueSeverity | null;
    created?: string | null;
    id?: string | null;
    issues?: Issues[] | null;
  };
  ...
  export type Issues = {
    __typename?: "XrayIssue";
    severity?: XrayIssueSeverity | null;
    type?: XrayIssueType | null;
    cve?: string | null;
    provider?: XrayIssueProvider | null;
    created?: string | null;
    summary?: string | null;
    description?: string | null;
    impacted_artifacts?: ImpactedArtifacts[] | null;
  };

  export type ImpactedArtifacts = {
    __typename?: "XrayArtifact";
    pkg_type?: XrayPackageType | null;
    path?: string | null;
    sha256?: string | null;
    name?: string | null;
    sha1?: string | null;
    ...
    infected_files?: InfectedFiles[] | null;
  };

  export type InfectedFiles = {
    __typename?: "XrayInfectedFile";
    name?: string | null;
    path?: string | null;
    sha256?: string | null;
    depth?: number | null;
